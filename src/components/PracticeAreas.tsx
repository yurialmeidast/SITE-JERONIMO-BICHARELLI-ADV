      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-7">
            <div className="bg-[#0C1B33] p-8 sm:p-10 lg:p-12 rounded-2xl border border-slate-800 shadow-2xl relative">
              ...
              <div className="mt-10 pt-6 border-t border-slate-800 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
                <button
                  ...
                  className="text-xs uppercase tracking-wider text-slate-300 hover:text-white underline underline-offset-4 font-medium transition-colors"
                >
